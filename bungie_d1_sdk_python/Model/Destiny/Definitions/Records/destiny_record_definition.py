...
class DestinyRecordDefinition(object):
    ...
    def __init__(self, display_properties=None, scope=None, presentation_info=None, lore_hash=None, objective_hashes=None, record_value_style=None, title_info=None, completion_info=None, state_info=None, requirements=None, hash=None, index=None, redacted=None):  # noqa: E501
