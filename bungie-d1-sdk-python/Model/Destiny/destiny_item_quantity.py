...
class DestinyItemQuantity(object):
    ...
    def __init__(self, item_hash=None, item_instance_id=None, quantity=None):  # noqa: E501
        """DestinyItemQuantity - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def item_hash(self):
        """Gets the item_hash of this DestinyItemQuantity.  # noqa: E501

        The hash identifier for the item in question. Use it to look up the item's DestinyInventoryItemDefinition.  # noqa: E501

        :return: The item_hash of this DestinyItemQuantity.  # noqa: E501
        :rtype: int
        """
    ...
    def item_hash(self, item_hash):
        """Sets the item_hash of this DestinyItemQuantity.

        The hash identifier for the item in question. Use it to look up the item's DestinyInventoryItemDefinition.  # noqa: E501

        :param item_hash: The item_hash of this DestinyItemQuantity.  # noqa: E501
        :type: int
        """
    ...
    def item_instance_id(self):
        """Gets the item_instance_id of this DestinyItemQuantity.  # noqa: E501
        ...
        :return: The item_instance_id of this DestinyItemQuantity.  # noqa: E501
        :rtype: int
        """
    ...
    def item_instance_id(self, item_instance_id):
        """Sets the item_instance_id of this DestinyItemQuantity.

        If this quantity is referring to a specific instance of an item, this will have the item's instance ID. Normally, this will be null.  # noqa: E501

        :param item_instance_id: The item_instance_id of this DestinyItemQuantity.  # noqa: E501
        :type: int
        """
    ...
    def quantity(self, quantity):
        """Sets the quantity of this DestinyItemQuantity.

        The amount of the item needed/available depending on the context of where DestinyItemQuantity is being used.  # noqa: E501

        :param quantity: The quantity of this DestinyItemQuantity.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DestinyItemQuantity):
            return False
