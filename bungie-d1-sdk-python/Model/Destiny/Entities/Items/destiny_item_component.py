...
class DestinyItemComponent(object):
    ...
    def __init__(self, item_hash=None, item_instance_id=None, quantity=None, bind_status=None, location=None, bucket_hash=None, transfer_status=None, lockable=None, state=None, override_style_item_hash=None, expiration_date=None):  # noqa: E501
