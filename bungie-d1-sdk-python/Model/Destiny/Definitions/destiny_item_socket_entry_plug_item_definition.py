...
class DestinyItemSocketEntryPlugItemDefinition(object):
    ...
    def __init__(self, plug_item_hash=None):  # noqa: E501
        """DestinyItemSocketEntryPlugItemDefinition - a model defined in OpenAPI"""  # noqa: E501
    ...
    def plug_item_hash(self):
        """Gets the plug_item_hash of this DestinyItemSocketEntryPlugItemDefinition.  # noqa: E501

        The hash identifier of a DestinyInventoryItemDefinition representing the plug that can be inserted.  # noqa: E501

        :return: The plug_item_hash of this DestinyItemSocketEntryPlugItemDefinition.  # noqa: E501
        :rtype: int
        """
    ...
    def plug_item_hash(self, plug_item_hash):
        """Sets the plug_item_hash of this DestinyItemSocketEntryPlugItemDefinition.

        The hash identifier of a DestinyInventoryItemDefinition representing the plug that can be inserted.  # noqa: E501

        :param plug_item_hash: The plug_item_hash of this DestinyItemSocketEntryPlugItemDefinition.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DestinyItemSocketEntryPlugItemDefinition):
            return False
