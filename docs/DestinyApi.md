...
[**get_historical_stats_definition**](DestinyApi.md#get_historical_stats_definition) | **GET** /Destiny/Stats/Definition/ | 
...
try:
    ...
    print("Exception when calling DestinyApi->get_public_xur_vendor: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling DestinyApi->get_record_book_completion_status: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling DestinyApi->get_special_event_advisors: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling DestinyApi->get_triumphs: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling DestinyApi->get_unique_weapon_history: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling DestinyApi->get_vault: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling DestinyApi->get_vault_summary: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling DestinyApi->get_vendor_for_current_character: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling DestinyApi->get_vendor_for_current_character_with_metadata: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling DestinyApi->get_vendor_item_detail_for_current_character: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling DestinyApi->get_vendor_item_detail_for_current_character_with_metadata: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling DestinyApi->get_vendor_summaries_for_current_character: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling DestinyApi->search_destiny_player: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling DestinyApi->set_item_lock_state: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling DestinyApi->set_quest_tracked_state: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling DestinyApi->transfer_item: %s\n" % e)
```
